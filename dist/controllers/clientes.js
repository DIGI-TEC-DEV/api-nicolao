...
exports.getClientes = exports.deleteCliente = exports.updateCliente = exports.getClienteById = exports.createCliente = void 0;
...
const createCliente = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const nuevoCliente = yield clientes_1.default.create({
            nombre,
            apellido,
            dni,
            direccion,
...
const getClienteById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const cliente = yield clientes_1.default.findByPk(idCliente);
        if (!cliente) {
